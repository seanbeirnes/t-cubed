            ...
            <div className="max-w-4xl w-full px-6">
                <header className="flex flex-col items-start gap-3 mb-10">
                    ...
                    <p className="text-slate-200 text-base md:text-lg">
                        Tic-Tac-Toe, reimagined! Challenge Minimax, a classic AI algorithm, or experience a <span className="text-amber-400 drop-shadow">neural network</span> with stunning live animations as you play against it.
                    </p>
                    <p className="text-slate-200 text-base md:text-lg">
